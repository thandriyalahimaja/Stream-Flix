...
async function runChallengerSecurityTests() {
  console.log("===============================================================================");
  console.log("CHALLENGER 2: ADVERSARIAL SECURITY, MULTI-TENANCY & ZERO SCORE LEAKAGE HARNESS");
  console.log("===============================================================================");
  ...
  // In tasteProfileService.js line 602: negScore >= 0.6
  // When a review was created slightly in the past (e.g. 50ms ago), decay < 1.0, so 0.6 * decay < 0.6
  const now = Date.now();
  const slightlyPastDate = new Date(now - 100); // 100ms ago
